...
| 2026-05-07 | validation_driven_model_rerun | Run completeness validation - 8/16 runs have broken assets | Medium | Open | Scripts/validate_run_completeness.py checks file sizes (<1KB rejected), asset count vs manifest, JSON validity. Failed runs: gemini-2.5-flash, gemini-2.5-pro, gemini-3-flash, gemini-3.1-pro (2), glm-4.7, gpt-5.4-mini-medium, minimax-m2.5 |